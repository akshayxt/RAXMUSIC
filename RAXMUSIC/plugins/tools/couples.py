...
#BOT FILE NAME
from RAXMUSIC import app as app
from RAXMUSIC.mongo.couples_db import _get_image, get_couple
...
@app.on_message(filters.command("fcouples"))
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "RAXMUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "RAXMUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("RAXMUSIC/assets/cppic.png")
