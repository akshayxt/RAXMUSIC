...
BOT_USERNAME = getenv("BOT_USERNAME" , "ANVIXROBOT")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "ANVIXT")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "ANVIXROBOT")
EVALOP = list(map(int, getenv("EVALOP", "6677597307 6753468481 6769261147").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002078269704))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6677597307))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Akshayxt/RaxMUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Team_x_t")
